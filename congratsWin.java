...
/**
 * Write a description of class congratsWin here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class congratsWin extends World
{
    ...
    public congratsWin(int prevLevel, int min, int stepsUsed)
    {    
    ...
    //sets secreen back to previous level (passed through the constructor)
    public void act()
    {
    ...
    public void prepare()
    {
        Text text = new Text("Min steps needed: " + min + "  Your Steps: " + stepsUsed);
        addObject(text,500,450);

        Text text2 = new Text("Press Enter to go BACK to level");
        addObject(text2,500,550);

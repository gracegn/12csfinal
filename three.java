 ...
 */
public class three extends levels
{
    //6 MOVES NEEDED ie P1 P1 P1 | P1: F F L
    ...
    private void prepare()
    {
        ...
        addObject(Platform1,500, 330);

        Platform Platform2 = new Platform();
        addObject(Platform2,445, 350);

        Platform Platform3 = new Platform();
        addObject(Platform3,390, 370);

        Platform Platform4 = new Platform();
        addObject(Platform4,445, 390);

        Platform Platform5 = new Platform();
        addObject(Platform5,610, 370);

        Platform Platform6 = new Platform();
        addObject(Platform6,555, 390);

        Platform Platform7 = new Platform();
        addObject(Platform7,500, 410);

        Objective objective = new Objective();
        addObject(objective,610,335);

        //Set hero
        //Starting position should be to front left
    ...
    public boolean checkOn(int xlocation, int ylocation)
    {
        ...
        if ((xlocation == 500 && ylocation == 330-55) || (xlocation == 445 && ylocation == 350-55) || 
        (xlocation == 390 && ylocation == 370-55) || (xlocation == 445 && ylocation == 390-55) || 
        (xlocation == 610 && ylocation == 370-55) || (xlocation == 555 && ylocation == 390-55) ||
        (xlocation == 500 && ylocation == 410-55) )
        {
            return true;
        }
        else
